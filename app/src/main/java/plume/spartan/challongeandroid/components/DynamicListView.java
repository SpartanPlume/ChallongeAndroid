...
package plume.spartan.challongeandroid.components;
...
import plume.spartan.challongeandroid.adapters.DynamicListViewAdapter;
...
public class DynamicListView extends ListView {
    ...
    public List<Object> mCheeseList;
    ...
    private long finalId = INVALID_ID;
    ...
    private AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ((DynamicListViewAdapter) getAdapter()).beginCellMove();
                    mTotalOffset = 0;
    ...
    private BitmapDrawable newHoverView(View v) {
        Bitmap b = getBitmapWithBorder(v);
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            ((DynamicListViewAdapter) getAdapter()).notifyDataSetChanged(new ArrayList<Object>(mCheeseList), getPositionForView(switchView));
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    mHoverCell = newHoverView(getViewForID(mMobileItemId));
                    if (originalItem >= 0) {
                        finalId = originalItem;
                        if (isBelow)
                            finalId += 2;
                    }
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            hoverViewAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ((DynamicListViewAdapter) getAdapter()).endCellMove((int) finalId);
    ...
    public void setCheeseList(List<Object> cheeseList) {
        mCheeseList = cheeseList;
    }

    public List<Object> getCheeseList() {
        return (mCheeseList);
    }

    public void addItemInCheeseList(Object obj) {
        mCheeseList.add(obj);
        ((DynamicListViewAdapter) getAdapter()).notifyDataSetChanged(new ArrayList<Object>(mCheeseList));
    }

    public int getCheeseListSize() {
        return (mCheeseList.size());
    }
